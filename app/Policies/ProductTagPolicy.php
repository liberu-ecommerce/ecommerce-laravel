...
class ProductTagPolicy
{
    ...
    {
        return $user->can('view_any_product::tag');
    }
    ...
    {
        return $user->can('view_product::tag');
    }
    ...
    {
        return $user->can('delete_any_product::tag');
    }
    ...
    {
        return $user->can('force_delete_product::tag');
    }
    ...
    {
        return $user->can('force_delete_any_product::tag');
    }
    ...
    {
        return $user->can('restore_product::tag');
    }
    ...
    {
        return $user->can('restore_any_product::tag');
    }
    ...
    {
        return $user->can('replicate_product::tag');
    }
    ...
    {
        return $user->can('reorder_product::tag');
    }
}
